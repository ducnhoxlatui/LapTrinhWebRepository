...
<%--    </table>--%>
    <div class="row mb-3">
        <p class="col-sm-8 col-form-label font-weight-bolder">Song title</p>
        <p class="col-sm-4 col-form-label font-weight-bolder">Audio format</p>
    </div>
    <div class="row mb-3">
        <label class="col-sm-8 col-form-label">You Are a Star</label>
        <label class="col-sm-4 col-form-label">Audio format</label>
    </div>
    <div class="row mb-3">
        <label class="col-sm-8 col-form-label">You Are a Star</label>
        <label class="col-sm-4 col-form-label">Audio format</label>
